//=================================================================================================================
//           TXLib.h - ���������� ������ ��������� (The Dumb Artist Library, TX Library, TXLib) - (C) Ilya Dedinsky
//=================================================================================================================
...
//!
//! @file    TXLib.h
//! @brief   <b>���������� ������ ��������� (The Dumb Artist Library, TX Library, TXLib).</b>
//!
//!          <b> �.�. ��������� </b><i><small> @n
//!          ������� ����������� � �������������� ���������� ���� @n
//!          ������� ���������� ���������������� ���� </small></i>
...
//!
//!          <b>����������� ���� ����������:</b>        <a href=http://txlib.ru><b>txlib.ru.</b></a> @n
//!          ��. ����� �������� ������� ��              <a href=http://sourceforge.net/p/txlib>SourceForge.</a>
//!
//!          <b>������-������������:</b>                <a href=http://storage.ded32.net.ru/Lib/TX/TXUpdate/Doc/HTML.ru><b>�����.</b></a>
//!          <b>�������� ������:</b>                    <a href=http://gg.gg/TXLib><b>gg.gg/TXLib</b></a>.
//!
//!          <b>������� TXBook �� ����������������:</b> <a href=http://storage.ded32.net.ru/Lib/TX/TXUpdate/TXBook.pdf><b>�����.</b></a>
//!          <b>�������� ������:</b>                    <a href=http://gg.gg/TXBook><b>gg.gg/TXBook</b></a>.
//!
//! @section Setup ��������� � ������������� ����������
//!
//!          <b>������� ����������:</b>                 <a href=http://sourceforge.net/project/platformdownload.php?group_id=213688>
//!          <b>�� ����� sourceforge.net.</b></a> ��. ����� ������ @ref TXLibSetup "��������� ����������".
//!
//! @note    ���������� TXLib ������� �� ������������� ����� � �� ������� ������� �������� � �����
//!          ����������������, ����� ��������� �� ��������� � ������ ��� ����������.
//!
...
//!          �����, ��� �� ������� ������ ���� ��� �������.
//!       -# �� ������� ����� �������� "����� ��� TX". �������� ��� � ��������� ������� ������ <tt>TXLib Help,</tt>
//!          ������� ��. ���������� ������ ��. <a href=http://storage.ded32.net.ru/Lib/TX/TXUpdate/Doc/HTML.ru/a00001.htm>
...
//!             - @c dbghelp32.dll, dbgco32.dll, symsrv32.dll, symsrv.yes - ��� 32-��������� ��������,
//!             - @c dbghelp64.dll, dbgco64.dll, symsrv64.dll, symsrv.yes - ��� 64-��������� ��������,
//!               @nn
//!          -# ������ ���������� <a href=https://github.com/jrfonseca/drmingw/releases>DrMinGW</a> (����� Jose Fonseca)
//!             ��� ������� � ���������� �������� MinGW ����������� GCC @c g++:
//!             - @c mgwhelp32.dll - ��� 32-��������� ��������,
//!             - @c mgwhelp64.dll - ��� 64-��������� ��������.
//!
...
//!
//!          ��� �������� ������ ����������� ������ ��������� ���������� ����������� ��� ����������. ��������,
//!          ��� ����������� GCC @c g++ -- � ������� ����� ��������� ������ @c -O0. <b>����������� ���������� ���� @c -g.</b>
//!          ������ ����� ���������������� ��������� ������ ��� ����� ��-�������, ��������, � CodeBlocks ����� ������� ���� --
//!          Settings -- Compiler -- (Global Compiler Settings) -- (Compiler Settings) -- Other Options.
//!
//! @note    ������� �������� � ��������� ����� ���������� ������ ���� ����������� ��� Windows CP1251, <b>���������
//!          ���.</b> � ������ ������ ���������� ��� ��������������� ��-�������, ��������, � CodeBlocks �����
//!          ������� ���� -- Settings -- Editor -- (General Settings) -- Other Settings -- Encoding. � MS Visual Studio
//!          Code ���� ������ F1 � ������ Reopen with Encoding -- Cyrillic (Windows 1251). ����� ������� ����� � ������
//!          � ���������� TXLib ����� ������������ �����������.
//!
//! @warning <b>��� �����-������. ��� ������������� ���������� ��������� ������������ � �� �������.</b> @n
...
//!          ����� � @c txMessageBox ���.@nn
//!
//! @note    ��� ����������� ���� @c txMessageBox ��������� ����� ���������, ����� ������� ���������� @c Shift,
//!          @c Control � @c Alt ������������ � �������� ������ �� ������ ���� @c [������] ��� @c [Cancel]. ���
//!          �������, ���� ���� @c txMessageBox ��������� ������������ � ����� � ��������� ������ ���������
//!          �������� �� ������ �������� ��������� ����.
//!
...
//! @ingroup Misc
//! @brief   ������������� Progress bar ���� �� ������ �����.
//!          <i>@strike ������ � ������ @endstrike ������� � ������ �������.</i>
//!
//! @param   percent  ������� ���������� ��������, �� 0 �� 100, ������������ ������ Progress bar'a �� ������ �����.
//! @param   type  <i>��� Progress bar'a. �������� ����� �� ������ <tt>Win32::TBPF_NORMAL, Win32::TBPF_ERROR,
//!                   Win32::TBPF_PAUSED, Win32::TBPF_NOPROGRESS, Win32::TBPF_INDETERMINATE.</tt> �������� ������
//!                   �������� � ���������. �������������. ���� �� �������, �� ������������ Win32::TBPF_NORMAL.</i>
//! @param   wnd   <i>���� ��� ������� Progress bar'a. �������������. ���� �� �������, �� ������������ txWindow().</i>
//!
//! @return  ������ ���������� �������. ���� ������������ �������� ����� 0 @c (S_OK), �� �������� �������.
//!
//! @usage @code
...
//  �������� ������ (����������) -- ��. txExtractColor(), txRGB2HSL(), txHSL2RGB(), txRGB2Lab(), txLab2RGB()

    TX_HUE          = 0x04000000,             //!< �������� ��� ����� � ������ HSL, @b [0; 255]
    TX_SATURATION   = 0x05000000,             //!< ������������ ����� � ������ HSL, @b [0; 255]
    TX_LIGHTNESS    = 0x06000000,             //!< ��������     ����� � ������ HSL, @b [0; 255]
    TX_LAB_L        = 0x07000000,             //!< L-���������� ����� � ������ Lab, @b [0; 255]
    TX_LAB_A        = 0x08000000,             //!< a-���������� ����� � ������ Lab, @b [0; 255]
    TX_LAB_B        = 0x09000000;             //!< b-���������� ����� � ������ Lab, @b [0; 255]
...
//!          int lightness = txExtractColor (TX_BLUE, TX_LIGHTNESS);  // � ��������� �� 0 �� 255
//!
...
//!
//!          - �������� ��� (Hue),        �� 0 �� @b 255 (@b �� �� 360).
//!          - ������������ (Saturation), �� 0 �� @b 255 (@b �� �� 100).
//!          - ��������     (Lightness),  �� 0 �� @b 255 (@b �� �� 100).
//!
//! @note    �������� �������������� �� ��������. ��� �������������� RGB->HSL->RGB ����� �������� ����������� �� 5.
//!
//! @see     txSetColor(), txGetColor(), txSetFillColor(), txGetFillColor(), txColors, RGB(), txExtractColor(),
...
//! @brief   ����������� ���� �� ������� RGB � ������ CIE Lab.
//!
//! @param   rgbColor  ������������� ���� � ������� RGB (sRGB).
//!
//! @return  ��������� ���� � ������ Lab � ���� COLORREF. ������� ��������������: D65/2.
//!
//!          ������ @b RGB ������������ ���
//!
//!          - ������� ���������� ����� (Red),   �� 0 �� 255.
...
//!          ������ @b Lab ������������ ���
//!
//!          - �������� @c L, �������� (Lightness), �� 0 �� @b 255 (@b �� �� 100).
//!          - �������� @c � (�������-�������),     �� 0 �� @b 255 (@b �� �� -100 �� +100).
//!          - �������� @c b (������-�����),        �� 0 �� @b 255 (@b �� �� -100 �� +100).
//!
//! @note    �������� �������������� �� ��������. ��� �������������� RGB->Lab->RGB ����� �������� ����������� �� 5.
//!
//! @see     txSetColor(), txGetColor(), txSetFillColor(), txGetFillColor(), txColors, RGB(), txExtractColor(),
...
//! @brief   ����������� ���� �� ������� CIE Lab � ������ RGB.
//!
//! @param   labColor  ������������� ���� � ������� CIE Lab.
//!
//! @return  ��������� ���� � ������ RGB (sRGB) � ���� COLORREF. ������� ��������������: D65/2.
//!
//!          ������ @b RGB ������������ ���
//!
//!          - ������� ���������� ����� (Red),   �� 0 �� 255.
...
//!
//! @return  ��������� ����� (��-�������� @d ����������, handle), �������� Windows ��� ���������� ������ (��-��������
//!          @d ��������� ���������, Device Context, DC). ������ ���������� Handle of Device Context == HDC.
//!
//!          ����� �������� �� ���� ������ ����� ��������, ��� � �� �������� ���� TXLib, ��������� �������� @c dc
//!          ������� ���������. ��������� ����� ����� ���� ����������� ��������� ������, ������� � �.�., ��������
//!          �� �������� ��������� ���� TXLib. ����� ������� ��������� ���������, ���������� ����������� ������
...
//!          ��� @c sizeX � @c sizeY -- ������� �����������. ����� ����������� ����� ����������� ����� ������. @nn
//!
//! @note    ������ ���� @b ����� ���������� @c TXLib.h � ��������� ����� ��������� ������ <tt>\#define _TX_DIB_FIX -1*</tt>
//!          ��� <tt>\#define _TX_DIB_FIX @b -</tt> �� ����� ���������� �� �����, ��� Y ����� ���������� ����� �����.
//!
//! @warning ������ ���������, �� �������� �� ������� �������, ����������� ����� ����������������. @nn
//!
//! @warning ��������� �������� ����� ����� ����� @b ����������� ������� ��� ������ txDeleteDC(). @n
...
//!
//! @title   ����� ��������:
//! @table   @tr LR_CREATEDIBSECTION @td ������� DIB (device-independent bitmap), ������� ��� ������� ������� � ������
...
//!
//! @note    ��� ������� ����� ����������� ��������, ���� ��������, ����������� � ������� txLoadImage() ��� �����������
//!          �����, ��������� � ������� txTransparentBlt() ��� txCreateDIBSection(), ������ �� �����. ����� ��������
//!          @strike ������ ���� @endstrike � Windows ����� ����������� ��������� ����������� HDC, � �������� �����
//!          ���������� ���� ������ Windows � �������� � ���������� �� ���� ����������. ����� ����, ����� ����� ��������
//!          ������������� ���������.
//!
//! @see     txCreateWindow(), txCreateCompatibleDC(), txLoadImage(), txDeleteDC(), txSaveImage(), txGetExtent(),
...
//!
//!          if (!background_CopiedFromHelp)
//!              txMessageBox ("�� ���� ��� �� ��������� Background.bmp, � ��, � ���� ���� ��� �� �������.", "Once again :(");
//!
//!          // ��. ������ ����������� � ������� � ������� txLoadImage!
//!
...
//!
//! @note    ����������� ������� @c Win32::TransparentBlt �� Win32 API @b ����� �������������� �����������. � txTransparentBlt
//!          ��� @b ������ ��� ��������� �������������. If you still need image scaling, use original function Win32::TransparentBlt
...
//!          �������� 255 -- ������ ��������������, ������������� �������� -- ����������������. @nn
//!
//!          ������ 32-������� �����������-�������� ����� ����� ���� ������� � ������� ������� txCreateCompatibleDC()
//!          ��� txCreateDIBSection(). ����� �������� �� ���� ����������� ����� ��������, ��� �� �������� ���� TXLib,
//!          ��������� �������� @c dc ������� ��������� �����.
//!
//! @warning ���� ����������� �� ����� �����-������, ��� ��� �����-����� ��������� ������, �� txAlphaBlend() �����
//!          ������, ��� ����������� ��������� ��������� � �� ������� �� ����� ������. @nn
//!
...
//!          ��������, ������������ ����� 3 (�������� 11) �������� ������������� ������� ����� � ������ ������.
//!
//! @warning ���� ���� TXLib ��� ��������������� ��� ���������� ���� ���������, �� ������������ @c 0. @nn
//!
//! @warning ������ ��������� � ������������� �������. ���� ��� ������� ������� �� �� ���� �����, ��� ������� ����,
//!          ����� ������ ������������ 0. ��. ��������� �� �������������� ������� ��� ������� @ref txCreateWindow(). @nn
//!
//! @warning ���� ����� ��������� ��������� ������ ����! � ����� ������, �� ����� ������������ �������� @c GetAsyncKeyState()
//!          � ����������� @c VK_LBUTTON, @c VK_RBUTTON ��� @c VK_MBUTTON. ������� ��� 16-�������� ����� (�������
//!          ����� @c 0x8000) ������� ��������� ��������������� ������ ����! (��. ������).
//!
//! @see     txMouseX(), txMouseY(), txMousePos(), txMouseButtons()
//!
...
//!
//! @param   text  ����� ��� @strike ������������ @endstrike ������, ��� ��� ������� @c printf().
//!
//! @return  ����� ������ ������ � ������������� (���� �� ������� ����� @c \\a). ���� -1, �� ����� �� ����������. :(
//!
...
//!          ���������� �� ����. ���� ���� ���� �� ������, �� ����� ������ ����������. @nn
//!          ���� ���� ����� ���� � ���� ������ ��������� MinGW: https://nuwen.net/mingw.html @nn
//!
//! @warning ���� ������ ������� �� ���������� .cpp-������, ��� ������ txSpeak ���� ������ �� ������ � ���� �� �����.
//!          ������ �� ������ ������ �� ����� ������������� �����. �������� � ������ ��� ���� ����, ��������, Speaking.cpp,
//!          � ��������� ��� ������ txSpeak � ���� ����.
//!
//! @note    �� ������ ����������� ������ ����, ��������� ���� �������� @b SSML (Speech Synthesis Markup Language).
//!          ��������� ������� �������� SSML �������� ������� ����������� ������� ������ @c < � ������ ��������� (�����
//!          ����� @c \\v � @c \\a). � ���� ������ ������ ��������� � ������������ @c &, ��������� � ������� "������"
//!          @c \< � "������" @c \>, � ����� ������� ������������� XML. ���� �� �� ������, ��� �������� �� � XML, ��
//!          �� �����������. ������� SSML ����� ������ ���������������, ����� ��������� ������, @strike ��� ��� �������
//!          � Microsoft. @endstrike @nn
//!          ���� ��� �� ��������, ��� ���� ������ ��� ��������� ��������� SSML, �� ��� ��� ��������� �� ��������.
//!          �������� �������-������� ��� txSpeak, ������ �������������, ��� ������ ������� � ���������� ������ ����������.
//!          �� �������� � @c vsnprintf @ (vsprintf), ��� ������� ��������� ��� ������ ���.
//!
...
//!
//!              txSpeak ("\v������ �����, ������. �� ��� ����. Goog evening, kittens. You are all mices.");
//!
...
template <typename T>
T max (const T& a, const T& b) { return (a > b)? a : b; }  //!< �������������� ������ ������� @ref MAX @ingroup Misc
...
template <typename T>
T min (const T& a, const T& b) { return (a < b)? a : b; }  //!< �������������� ������ ������� @ref MIN @ingroup Misc
...
//! @param   size    ������ ������
//!
//! @return  �������� ���� ������ �� ��������� <a href=https://en.wikipedia.org/wiki/Daniel_J._Bernstein>DJB2 (GNU Hash).</a>
//!
//! @usage @code
//!          char str[1024] = "";
...
inline double txSqr (double x)
    ...
    char str[1024] = "";
    _snprintf_s (str, sizeof (str), "���������� ���� %g!" "!!" "!!" " �� ����??1!!", sqr);
    txMessageBox (str, "������� �����!" "!!", MB_ICONEXCLAMATION | MB_YESNO) != IDCANCEL ||
        (
        txMessageBox ("����...", "� � ��� ���������", MB_ICONINFORMATION),
        txMessageBox ("���� � �� ���", "���� ��...",  MB_ICONSTOP),
...
//!          ������ ������� ��������� �� �������, ��������� ��� ������ ���, ��� ����� ��� ���� �� ���� �������.
//!
//! @param   required    @a (true/false) ����������� �� ��������� ������������� �������. ���� �����������, �� � ������
//!                                      ���������� ������� ����� ��������� ������.
//! @param   libName     @a (char*)      ��� ����������, ������� ���������� (������ @c .dll).
//! @param   retValType                  ��� ������������� �������� ������������� �������.
//! @param   funcName    @a (char*)      ��� ������������� �������.
//! @param   funcParams                  ��������� ������������� �������.
//! @param   callType                    ��� ������ ������������� ������� (��� ������� Windows - @c WINAPI).
//!
//! @warning ���� �������� @c required ����� @c false, � ������� � ���������� �� �������, ��� ���������� �� �����������,
//!          �� ��������� �� ������� ����� @c NULL � ��� �� ������ ��������� ������. ����������, ����� �� ���� ���������
//!          ����� ����� �������.
//!
//! @usage @code
...
//!
//!              OPENFILENAME ofn    = { sizeof (ofn), txWindow() };  //  +-- ������� ���� ������... �� ����������� ������ 20 ������
//!                                                                   //  V
...
//! @param   wLocale   <i>����� ������ ����������� ���������� �++ ��� wide character functions.
...
//! @brief   ���������������� ��������� �� ������� �� ����� �������.
//!
//! @param   message  <i>���������, ��������� � ������� ����� stderr, � ������� printf(). �������������.</i>
//!
//! @return  ��� �������, ������� ��� ������ �� �����.
//!
//! @note    ��� ������� Ctrl+C ��������� �������� �����������.
...
//!
//! @title   ������� ������������ ���������� �����: @table
//!          @tr ��� ������������ @c g++ (MinGW, Cygwin) � @c clang, ������������ � CodeBlocks, CLion � �.�.
//!          @td -- ������ ����������� ���� @c -mwindows � ����� ���� @c -mconsole.
//!          @tr ��� ������������ ��������� Microsoft Visual Studio
//!          @td -- ������ @b �� ������ ����������� ����������, � "Desktop Application" ��� �����������.
//!          @endtable
//!
//! @note    ��������� �������� @b �� ��������� ����� @ref TXLib.h � ���������. @nn
//!
//! @warning ���� �� ������� ������������ ���������� (��. ����), �� ���������� ��� �� ����� ����������������
//!          (��������, CodeBlocks), �� �� ������ ������� ������ ���������� ���� ��������� ���������, � �������
//!          ������� ����� ���������������� ��������� ���� ����������. ���� �� ��������� ���� ������������
...
//!          ��������� ����������� �������� ��� �������. ����������� �������� �������� ����������� ���������, �����
//!          ���������. ��� ���������, ������������ � ������� ����� - ����. ������ ��� ������� CLion, ��. �������
//!          _txCleanup() � _txIsParentListed() � �������� ������ @ref TXLib.h.
//!
//!          ����� ���������� ����� ���������� TXLib.h � ���������.
//!
...
$   if (_txConsole)
        {
//      _txCheckSourceCP (_TX_CODEPAGE, true);  // disabled: local TXLib.h codepage check
...
$           _txSetWindowText (console, " [���������]", " [FINISHED]", 2, L"\x0417" /* '�' */ L"\x0046" /* 'F' */);
            }
        }

$   if (_txMain && !externTerm && canvas)
        {$  _txSetWindowText (canvas,  " [���������]", " [FINISHED]", 2, L"\x0417" /* '�' */ L"\x0046" /* 'F' */); }
...
$   SetConsoleOutputCP (_TX_CODEPAGE);
    ...
    if (*message != '\f') {$ _txSetWindowText (wnd, " [������� �������...]", " [Press a key...]"); }
    else                  {$ message++; }
...
$3  if (_TX_ARGUMENT_FAILED ((name || cmdLineSubstr || pid) && "��� ����� ��� ���������� ����� �����������...")) return false;  //-V560 //-V601
...
$   if (_txCanvas_UserDCs && !_txCanvas_UserDCs->empty())
        {
$       txNotifyIcon (NIIF_ERROR, NULL, "�� ������ ���������� %d HDC.", (int) _txCanvas_UserDCs->size());  //-V202
$       Sleep (_TX_TIMEOUT);
...
$   _TX_UNEXPECTED ("_matherr(): �������������� ������ %d %s � ������� %s (%g, [%g]). ��� ������ �������� %g.\n\n"
                    "� ������� __setusermatherr() �� ������ ���� ���������� ��� ������.",
...
$   switch (code)
        ...
        GET_DESCR_ (STATUS_LONGJUMP,                    " "  "��������� longjmp().")
...
$       if (params >= 2) {$ PRINT_ ((object? " �� ������ 0x%p" : " �� ������ NULL"), object); }   //-V1048
        else             {$ PRINT_ (" (����� �� ������)"); }
...
$   PRINT_ ((object? "%s��� ����� 0x%p." : "%s��� ����� NULL."), ((typeName || mangledName)? ", " : ""), object);  //-V560
...
$       n++;
        ...
        if (addr == (void*)(uintptr_t) 0xBAADF00D) {$ PRINT_ (" [����� �� LocalAlloc()]"); break; }  //-V566
...
$   int bits = sizeof (void*) * CHAR_BIT;
    if (!Win32::SymSetOptions || !Win32::MinGW::SymSetOptions) {$ PRINT_ ("TXLib ���������: �� ����������� ����������"); }
    if (!Win32::SymSetOptions)                                 {$ PRINT_ (" DbgHelp%d.dll ��� DbgHelp.dll,", bits); }
    if (                         !Win32::MinGW::SymSetOptions) {$ PRINT_ (" MgwHelp%d.dll ��� MgwHelp.dll,", bits); }
    if (!Win32::SymSetOptions || !Win32::MinGW::SymSetOptions) {$ PRINT_ (" ���������� ���������� ���������� :(\n"); }
...
$       TX_ERROR ("�������� x0 = %g ������, ��� x1 = %g. ����� ���������� �� �����.", x0, x1);
        }

$   if (y0 > y1)
        {
$       SetLastError (ERROR_INVALID_DATA);
$       TX_ERROR ("�������� y0 = %g ������, ��� y1 = %g. ����� ���������� �� �����.", y0, y1);
        }
...
$   if (_txCanvas_UserDCs->size() >= _TX_BUFSIZE)
        {$ txNotifyIcon (NIIF_WARNING, NULL, "�� ��������� ��� %d HDC, ������� ����� ����� �����.", (int) _txCanvas_UserDCs->size()); }  //-V202
...
$   if (Win32::TransparentBlt)
        ...
        // (!) � ��� ������ ��� ���� ������ ������.
        //
        // ���� - ��� ����� ����������� Win32::TransparentBlt() �� ���� Windows. ��������� "Windows TransparentBlt function"
        // � ��������� ��� �� ���������.
        //
        // ��� ������, ������������ ������� �� Win32 ��������� ������� �� ������ ��������, �� � �������� ��������, � ���� ��� ��
        // ���������, �� �������� ����� ��������� ��� ���������. TXlib'������ <s>�������</s> ������� TransparentBlt ������������, ���
        // ��� ������� ������ ���������, � ������� ��� ������ � TransparentBlt() ������� ����� ������ 1:1. <s>��� ���� �������, ��</s>
        // ��� ������� ��� ��������� ������ ������� TransparentBlt().
...
$       ok &= txGDI (!!(Win32::TransparentBlt (destImage,   ROUND (xDest),   ROUND (yDest),   ROUND (width), ROUND (height),               // <<<<
                               ...
                               //                                                                    |||||          ||||||                 // <<--
                               //                                                                                                          // <<--
        }                      // ��. "TransparentBlt function" � Google, ����� ����� ���������� wSrc � wDest (hSrc � hDest). �������!     // <<--
    else
        {
$       ok &= txGDI (!!(Win32::BitBlt         (destImage,   ROUND (xDest),   ROUND (yDest),   ROUND (width), ROUND (height),
    ...
    // � TXLib-������ ������� txTransparentBlt() �������� � ������������ ������, ��� �������� ����, � ��� ��� �� ��������, ���
    // �������� ������� ���� ����������� ������� ��� ����������� �������� �����������. <s>���� �� ������� �� ����� �����,</s>
    // �������� � ���� TXLib'� �� ����������� GDI Win32, <s>���� GDI ���� ��� ����, ��� ��� ����� ������ GDI+, SFML, OpenGL
    // ��� DirectX, ����� �����. ���� ��� � �������.</s>
...
$       txPause ("\v%-*s CodePage = %5u", (int) sizeof (void*) * 2 + 16*3, "[������� ����� ������� ��� �����������]", oldCP);
        }
...
//!          @tbr
//!          @tr <tt> $ptrHTML (html, ptr, [backColor]) </tt> @td ������ ��������� @c ptr � HTML-���� @c html ������, ��������� �� �������� ���������,
//!                                                               ��� HTML-�����. <i>[backColor] @d �������������� ���� ����, �� ��������� �����.</i>
//!          @tbr
//!          @tr <tt> $n                                </tt> @td ������� ������ (������ @c '\\n').
//!          @tr <tt> $nn                               </tt> @td ������  ������ (������ @c '\\n\\n').
//!          @tr <tt> $t                                </tt> @td ���������      (������ @c '\\t').
...
#define $ppp   { $sy; txPause ("\v[%s ""%s: ""������� �������]...", __TX_FILELINE__, __TX_FUNCTION__); }
#define $pp    { $sy; txPause ("\v[%04d %s: ""������� �������]...", __LINE__,        __TX_FUNCTION__); }
#define $p     { $sy; txPause ("\v[%s ""%s(): ������� �������]...", __TX_FILELINE__, __func__);        }
...
#define ERRPTR_(p)  { $sE; stream << "<�������� ����� " << (const void*) (p) << ">"; }
